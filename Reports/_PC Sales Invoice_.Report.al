report 80204 "PC Sales Invoice"
{
        ...
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(CompBankBranch;CompanyInfo."Bank Branch No.")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        dataitem(AsmLoop;"Integer")
                        {
                            ...
                            trigger OnAfterGetRecord()var ItemTranslation: Record "Item Translation";
                            begin
                            ...
                            trigger OnPreDataItem()var PostedAssemblyLine: Record "Posted Assembly Line";
                            DummyValueEntry: Record "Value Entry";
                            begin
                                Clear(TempPostedAsmLine);
                                if not DisplayAssemblyInformation then CurrReport.Break();
                                PostedAssemblyLine.GetAssemblyLinesForDocument(TempPostedAsmLine, DummyValueEntry."Document Type"::"Sales Invoice", "Sales Invoice Line"."Document No.", "Sales Invoice Line"."Line No.");
                                Clear(TempPostedAsmLine);
                    ...
                    dataitem(PaymentReportingArgument;"Payment Reporting Argument")
                    {
                        ...
                        trigger OnPreDataItem()var PaymentServiceSetup: Record "Payment Service Setup";
                        begin
            ...
            trigger OnAfterGetRecord()var Handled: Boolean;
            begin
    ...
    trigger OnPostReport()begin
        if LogInteraction and not IsReportInPreviewMode then if "Sales Invoice Header".FindSet then repeat if "Sales Invoice Header"."Bill-to Contact No." <> '' then SegManagement.LogDocument(SegManagement.SalesInvoiceInterDocType, "Sales Invoice Header"."No.", 0, 0, DATABASE::Contact, "Sales Invoice Header"."Bill-to Contact No.", "Sales Invoice Header"."Salesperson Code", "Sales Invoice Header"."Campaign No.", "Sales Invoice Header"."Posting Description", '')
                    else
    ...
    var Text004: Label 'Sales - Invoice %1', Comment='%1 = Document No.';
    ...
    local procedure InitializeShipmentBuffer()var SalesShipmentHeader: Record "Sales Shipment Header";
    ...
    local procedure GenerateBufferFromValueEntry(SalesInvoiceLine2: Record "Sales Invoice Line")var ValueEntry: Record "Value Entry";
    ...
    local procedure GenerateBufferFromShipment(SalesInvoiceLine: Record "Sales Invoice Line")var SalesInvoiceHeader: Record "Sales Invoice Header";
    ...
    local procedure CorrectShipment(var SalesShipmentLine: Record "Sales Shipment Line")var SalesInvoiceLine: Record "Sales Invoice Line";
    begin
    ...
    local procedure DocumentCaption(): Text[250]var DocCaption: Text;
    begin
    ...
    NewDisplayAdditionalFeeNote: Boolean)begin
    ...
    local procedure FormatDocumentFields(SalesInvoiceHeader: Record "Sales Invoice Header")begin
    ...
    local procedure FormatAddressFields(SalesInvoiceHeader: Record "Sales Invoice Header")begin
        FormatAddr.GetCompanyAddr(SalesInvoiceHeader."Responsibility Center", RespCenter, CompanyInfo, CompanyAddr);
        FormatAddr.SalesInvBillTo(CustAddr, SalesInvoiceHeader);
        ShowShippingAddr:=FormatAddr.SalesInvShipTo(ShipToAddr, CustAddr, SalesInvoiceHeader);
    end;
    local procedure GetUOMText(UOMCode: Code[10]): Text[50]var UnitOfMeasure: Record "Unit of Measure";
    begin
    ...
    local procedure GetLineFeeNoteOnReportHist(SalesInvoiceHeaderNo: Code[20])var LineFeeNoteOnReportHist: Record "Line Fee Note on Report Hist.";
    ...
    begin
        ...
        if LineFeeNoteOnReportHist.FindSet then begin
            repeat InsertTempLineFeeNoteOnReportHist(LineFeeNoteOnReportHist, TempLineFeeNoteOnReportHist);
            until LineFeeNoteOnReportHist.Next = 0;
        end
        else
        begin
            LineFeeNoteOnReportHist.SetRange("Language Code", Language.GetUserLanguageCode);
            if LineFeeNoteOnReportHist.FindSet then repeat InsertTempLineFeeNoteOnReportHist(LineFeeNoteOnReportHist, TempLineFeeNoteOnReportHist);
                until LineFeeNoteOnReportHist.Next = 0;
        end;
    end;
    ...
    var AmtInclVATRemainderAfterRoundingLCY2: Decimal)var VATBaseLCY: Decimal;
    ...
    var TempLineFeeNoteOnReportHist: Record "Line Fee Note on Report Hist." temporary)begin
    ...
    procedure OnAfterGetRecordSalesInvoiceHeader(SalesInvoiceHeader: Record "Sales Invoice Header")begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetDocumentCaption(SalesInvoiceHeader: Record "Sales Invoice Header";
    var DocCaption: Text)begin
    end;
    [IntegrationEvent(false, false)]
    [Scope('OnPrem')]
    ...
    [IntegrationEvent(TRUE, false)]
    local procedure OnAfterPostDataItem(var SalesInvoiceHeader: Record "Sales Invoice Header")begin
    end;
}
