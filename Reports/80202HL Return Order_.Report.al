report 80202 "HL Return Order"
{
    ...
    trigger OnPostReport()begin
        if LogInteraction and not IsReportInPreviewMode then if "Purchase Header".FindSet then repeat if "Purchase Header"."Buy-from Contact No." <> '' then SegManagement.LogDocument(22, "Purchase Header"."No.", 0, 0, DATABASE::Contact, "Purchase Header"."Buy-from Contact No.", "Purchase Header"."Purchaser Code", '', "Purchase Header"."Posting Description", '')
                    else
    ...
    var Text004: Label 'Return Order %1', Comment='%1 = Document No.';
    ...
    local procedure FormatAddressFields(PurchaseHeader: Record "Purchase Header")begin
