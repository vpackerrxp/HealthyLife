codeunit 80005 "HL Reconcillations"
{
    procedure Build_Cash_Receipts(var Buff:record "HL Shopify Order Header";PostDate:date)
    var
    ...
    procedure Build_Reconcilliation_Cash_Receipts(var Buff:record "HL Order Reconciliations" temporary;FeeAcc:Code[20];PostDate:Date;Fee:Decimal)
    var
        GenJrnlBatch:record "Gen. Journal Batch";
        GenJrnl:Record "Gen. Journal Line";
        GenTemplate:Record "Gen. Journal Template";
        ...
        TmpBuff1:record "HL Order Reconciliations" temporary;
        TmpBuff2:record "HL Order Reconciliations" temporary;
        RecCon:Record "HL Order Reconciliations";
        CustLed:record "Cust. Ledger Entry";
        RecTot:Record "HL Reconciliation Totaler" temporary;
        ExFlg:Boolean;
        OrdFlg:boolean;
        i:Integer;
    begin
    ...
    var
        ...
        PstDate:array[2] of date;
        OrdHdr:Record "HL Shopify Order Header";
        TmpBuff:record "HL Order Reconciliations" temporary;
        RecCon:Record "HL Order Reconciliations";
        CustLed:record "Cust. Ledger Entry";
        RecTot:Record "HL Reconciliation Totaler" temporary;
        ExFlg:Boolean;
